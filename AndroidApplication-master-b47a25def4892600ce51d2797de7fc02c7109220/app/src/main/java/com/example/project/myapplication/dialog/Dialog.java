...
public class Dialog extends AppCompatDialogFragment {
    ...
    public android.app.Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        etBroker = (EditText) view.findViewById(R.id.brokerText);
        etPort = (EditText) view.findViewById(R.id.portText);
...
//properly after a rotation.
        ...
        if(d != null)
        {
            ...
            positiveButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    String broker = etBroker.getText().toString();
                    String port = etPort.getText().toString();
                    if(!broker.isEmpty() && !port.isEmpty()){
                        wantToCloseDialog = true;
                        listener.applyText(broker,port);
                    }else{
                        Toast.makeText(getContext(),"Fill any empty fields", Toast.LENGTH_SHORT).show();
                    }
    ...
    public interface DialogListener{
        void applyText(String broker, String port);
    }
}
